...
def main():
    ...
    # We only consider one idiom per instance in the dataset, a sentence containing multiple idioms will be split
    # into multiple instances. The idiom tag of each instance will be replaced with 4 [MASK] tokens.
