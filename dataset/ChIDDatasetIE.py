...
class ChIDDatasetIE(Dataset):
    def __init__(self, data_path, chid_file="train_data_5w.json", idiom_file="idioms_ChID.json",
        ...
        for single_raw_dat in raw_data:
        ...
        self.data = {
            ...
            "sentence_mask": sentence_tokenization_output["attention_mask"],
            # 1 for idiom mask tokens, 0 for others
            "idiom_token": (sentence_tokenization_output["input_ids"] == tokenizer.mask_token_id).int(),
